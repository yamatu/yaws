...
function migrate(db: Db) {
  ...
  ensureColumns(db, "machines", [
    ...
    { name: "ssh_host", sql: "ALTER TABLE machines ADD COLUMN ssh_host TEXT NOT NULL DEFAULT ''" },
    { name: "ssh_port", sql: "ALTER TABLE machines ADD COLUMN ssh_port INTEGER NOT NULL DEFAULT 22" },
    { name: "ssh_user", sql: "ALTER TABLE machines ADD COLUMN ssh_user TEXT NOT NULL DEFAULT ''" },
