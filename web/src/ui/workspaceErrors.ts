const errors: Record<string, string> = {
  ...
  official_model_invalid: "官方模型配置无效，请重新从官方模型列表添加",
  official_not_logged_in: "官方账号尚未登录，请在模型配置中授权",
  official_auth_corrupt: "官方账号凭据无法解密，请重新登录",
  official_auth_failed: "官方授权凭据无效，请重新登录",
  official_auth_expired: "官方授权已过期或刷新失败，请重新登录",
